...
function HomeContent() {
  ...
  // ---------------------------------------------------------------------------
  // 1. DATA FETCHING (Status & Webhooks)
  // ---------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------
  // 2. CORE LOGIC: REACT TO STATUS CHANGE (The "Auto-Close" Feature)
  // ---------------------------------------------------------------------------
  useEffect(() => {
  ...
  // ---------------------------------------------------------------------------
  // 3. CORE LOGIC: HANDSHAKE (Signal from Tab 2)
  // ---------------------------------------------------------------------------
    ...
    const checkStorage = () => {
        ...
        if (raw) {
            try {
                ...
                // Only react if signal is fresh (< 30s old)
